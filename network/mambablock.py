...
if __name__ == '__main__':
    model = MambaLayerlocal(dim=128).to('cuda')
    input = torch.randn(2, 5, 128, 128, 128).to('cuda')
    output = model(input,hilbert_curve='/media/byc/MyDisk/Pycharm_Projects/RISE_Mamba/hilbert_curve/5_64.pt')
    print(output.shape)