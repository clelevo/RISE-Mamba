...
def test_RISE_Mamba(**args):
	...
	with torch.no_grad():
		...
		for seq, name in dataset_test:
			...
			seq = seq.to(device)
			[F_num, C, H, W] = seq.shape # 5,1,256,320
...
if __name__ == "__main__":
	...
	parser.add_argument("--model_file", type=str,
						default="./pretrain/RainMamba_DTFF_Up_IDC_Only_Local_net.pth",
	...
	parser.add_argument("--max_num_fr_per_seq", type=int, default=5,
	...
	# noise sigma
	parser.add_argument("--val_noiseL", type=float, default=25, help='noise level used on test set')  # 25 --> 0
	...
	parser.add_argument("--save_noisy", default=False, action='store_true', help="save noisy frames")
